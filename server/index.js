...
function Navbar() {
  return /* @__PURE__ */ jsxs("nav", { className: "navbar", children: [
    /* @__PURE__ */ jsx(Link, { to: "/", children: /* @__PURE__ */ jsx("p", { className: "text-2xl text-gradient font-bold", children: "Resumes" }) }),
      ...
      children: [
        /* @__PURE__ */ jsxs("div", { className: "resume-card-header", children: [
          /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
            companyName && /* @__PURE__ */ jsx("h2", { className: "text-black! font-bold wrap-break-word", children: companyName }),
            jobTitle && /* @__PURE__ */ jsx("h3", { className: "text-lg wrap-break-word text-gray-500", children: jobTitle }),
            !companyName && !jobTitle && /* @__PURE__ */ jsx("h2", { className: "text-black! font-bold wrap-break-word", children: "Resume" })
          ] }),
          /* @__PURE__ */ jsx("div", { className: "shrink-0", children: /* @__PURE__ */ jsx(ScoreCircle, { score: feedback.overallScore }) })
        ] }),
        resumeUrl && /* @__PURE__ */ jsx("div", { className: "gradient-border animate-in duration-1000 fade-in", children: /* @__PURE__ */ jsx("div", { className: "w-full h-full", children: /* @__PURE__ */ jsx(
          "img",
          {
            src: resumeUrl,
            alt: "resume",
...
function meta$2() {
  return [{
    ...
    name: "description",
    content: "Smart feedback for your dream jop!"
  }];
}
const home = UNSAFE_withComponentProps(function Home() {
  ...
  useEffect(() => {
    const loadResumes = async () => {
      ...
      const parsedResumes = storedResumes.map((item) => JSON.parse(item.value));
  ...
  return /* @__PURE__ */ jsxs("main", {
    ...
    children: [/* @__PURE__ */ jsx(Navbar, {}), /* @__PURE__ */ jsxs("section", {
      ...
      children: [/* @__PURE__ */ jsxs("div", {
        ...
        }), !loading && resumes.length === 0 ? /* @__PURE__ */ jsxs(Fragment, {
      ...
      }), !loading && resumes.length > 0 && /* @__PURE__ */ jsx("div", {
      ...
      children: /* @__PURE__ */ jsxs("section", {
        ...
        children: [/* @__PURE__ */ jsxs("div", {
          ...
          children: [/* @__PURE__ */ jsx("h1", {
            ...
            children: "Log In to Continue Your Jop Journey"
          })]
        }), /* @__PURE__ */ jsx("div", {
...
function FileUploader({ onFileSelect }) {
  ...
  const [file, setFile] = useState(acceptedFiles[0] || null);
  return /* @__PURE__ */ jsx("div", { className: `w-full gradient-border`, children: /* @__PURE__ */ jsxs("div", { ...getRootProps(), children: [
    ...
    /* @__PURE__ */ jsx("div", { className: `space-y-4 cursor-pointer`, children: file ? /* @__PURE__ */ jsxs("div", { className: `uploader-selected-file`, onClick: (e) => e.stopPropagation(), children: [
      ...
      /* @__PURE__ */ jsx("button", { className: `p-2 cursor-pointer`, onClick: () => {
        setFile(null);
        onFileSelect?.(file);
...
const upload = UNSAFE_withComponentProps(function Upload() {
  const {
    auth: auth2,
    fs,
    ai,
  ...
  const handleSubmit = (e) => {
    ...
    const companyName = DOMPurify.sanitize(formData.get("company-name"));
    const jobTitle = DOMPurify.sanitize(formData.get("job-title"));
    const jobDescription = DOMPurify.sanitize(formData.get("job-description"));
    if (!file) return;
    handleAnalyze({
      companyName,
      jobTitle,
...
const Category = ({ title, score }) => {
  ...
  return /* @__PURE__ */ jsx("div", { className: "resume-summary", children: /* @__PURE__ */ jsxs("div", { className: "category", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "text-2xl", children: /* @__PURE__ */ jsx("span", { className: getColorClass(), children: score }) })
  ] }) });
};
function Summary({ feedback }) {
  return /* @__PURE__ */ jsxs("div", { className: "bg-white rounded-2xl shadow-md w-full", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row items-center p-4 gap-8", children: [
      /* @__PURE__ */ jsx(ScoreGauge, { score: feedback?.overallScore || 0 }),
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
        /* @__PURE__ */ jsx("h3", { className: "text-2xl font-bold", children: "Overall Score" }),
        /* @__PURE__ */ jsx("p", { className: "text-gray-600", children: "These score is calculated based on the variables listed below." })
      ] })
    ] }),
    /* @__PURE__ */ jsx(Category, { title: "Tone & Style", score: feedback?.toneAndStyle.score || 0 }),
    /* @__PURE__ */ jsx(Category, { title: "Content", score: feedback?.content.score || 0 }),
    /* @__PURE__ */ jsx(Category, { title: "Structure", score: feedback?.structure.score || 0 }),
    /* @__PURE__ */ jsx(Category, { title: "Skills", score: feedback?.skills.score || 0 })
  ] });
}
...
const CategoryContent = ({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4 items-center w-full", children: [
    /* @__PURE__ */ jsx("div", { className: "bg-gray-50 w-full rounded-lg px-5 py-4 grid grid-cols-2 gap-4", children: tips.map((tip, index) => /* @__PURE__ */ jsxs(
      "div",
      {
...
const Resume = () => {
  ...
  useEffect(() => {
    const loadResume = async () => {
      ...
      const resumeFile = await fs.read(data.resumePath);
      if (!resumeFile) return;
      const pdfBlob = new Blob([resumeFile], {
...
const serverManifest = { "entry": { "module": "/assets/entry.client-CtWIKUWr.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js"], "css": [] }, "routes": { "root": { "id": "root", "parentId": void 0, "path": "", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": true, "module": "/assets/root-vGCR8e1H.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js", "/assets/puter-wk4xiy6I.js"], "css": ["/assets/root-D1-HwT0f.css"], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/home": { "id": "routes/home", "parentId": "root", "path": void 0, "index": true, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/home-BOpf-s3b.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js", "/assets/navbar-ChKbOL7R.js", "/assets/puter-wk4xiy6I.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/auth": { "id": "routes/auth", "parentId": "root", "path": "/auth", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/auth-BZi_Mw3b.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js", "/assets/puter-wk4xiy6I.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/upload": { "id": "routes/upload", "parentId": "root", "path": "/upload", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/upload-ndM_rLas.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js", "/assets/navbar-ChKbOL7R.js", "/assets/utils-BfpOqbi7.js", "/assets/puter-wk4xiy6I.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/resume": { "id": "routes/resume", "parentId": "root", "path": "/resume/:id", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/resume-CgFdoyMP.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js", "/assets/puter-wk4xiy6I.js", "/assets/utils-BfpOqbi7.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 }, "routes/wipe": { "id": "routes/wipe", "parentId": "root", "path": "/wipe", "index": void 0, "caseSensitive": void 0, "hasAction": false, "hasLoader": false, "hasClientAction": false, "hasClientLoader": false, "hasClientMiddleware": false, "hasErrorBoundary": false, "module": "/assets/wipe-COMutlm4.js", "imports": ["/assets/chunk-FGUA77HG-Dqo2TTdq.js", "/assets/puter-wk4xiy6I.js"], "css": [], "clientActionModule": void 0, "clientLoaderModule": void 0, "clientMiddlewareModule": void 0, "hydrateFallbackModule": void 0 } }, "url": "/assets/manifest-d02b0513.js", "version": "d02b0513", "sri": void 0 };
